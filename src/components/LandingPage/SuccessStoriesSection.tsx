...
export default function SuccessStoriesSection() {
  ...
  return (
    ...
    >
      {/*
        Uncomment the block below to display the carousel:

        <div className="w-full gap-12 flex flex-col items-start">
          <div className="flex flex-col items-center gap-2 self-stretch w-full relative">
            <div className="relative self-stretch mt-[-1px] font-other-caption text-[#00c2c6] text-[length:var(--other-caption-font-size)] text-center tracking-[var(--other-caption-letter-spacing)] leading-[var(--other-caption-line-height)] [font-style:var(--other-caption-font-style)] font-semibold">
      ...
      */}
      ...
      <motion.div style={{ height }} className="relative mt-[100px] bg-red">
        <div
          className="h-[1550%] w-[120%] left-[-10%] radius-[0_0_50%_50%] bg-white z-1 absolute shadow-lg"
