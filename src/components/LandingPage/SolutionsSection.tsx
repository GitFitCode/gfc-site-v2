  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="inline-flex items-center justify-center h-14 px-6 bg-[#00c2c6] text-white rounded-lg hover:bg-gfc-primary-100 hover:text-black transition duration-300"
      >
