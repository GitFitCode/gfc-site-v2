      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-8 sm:py-12 lg:py-14 flex flex-col items-center">
          ...
          <div className="relative z-10 w-3/4 text-white text-center px-4 sm:px-6 space-y-10">
            ...
            <button onClick={handleButtonClick} className="mt-6 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 bg-gfc-light text-gfc-accent rounded-lg font-semibold flex items-center gap-2 hover:bg-gfc-primary hover:text-white transition-colors group mx-auto ">
