...
export default function StatisticsSection() {
  ...
  return (
    <section
      id="stats-section"
      className="flex flex-col my-[10rem] items-center gap-[60px] bg-defaultwhite"
    >
      ...
      <div className="flex w-[90%] md:w-[80%] justify-around flex-col md:flex-row gap-10 md:gap-0">
        ...
        <div className="flex flex-col items-center">
          <p className="  font-black text-transparent text-[84.2px] tracking-[1.40px] leading-[normal]">
            <span className="text-[#00c2c6] tracking-[1.18px] font-black">
              7
            </span>
        ...
        <div className="">
          <p className="font-normal text-transparent text-[22px] text-center tracking-[0] leading-[28.2px]">
            <span className="text-black">
              At GFC we specialize in delivering custom software solutions that
              drive business success. Our team of experienced developers and
              designers is passionate about turning complex challenges into
      ...
      <div
        ...
        className="all-[unset] box-border inline-flex h-14 items-center justify-center p-4 relative mb-[-8.25px] bg-[#00c2c6] text-white rounded-lg hover:bg-gfc-primary-100 hover:text-black transition duration-300"
      >
        <div className="inline-flex items-center justify-center gap-2.5 px-4 py-0 relative flex-[0_0_auto]">
          <div className="w-fit mt-[-1.00px] font-button-l text-defaultwhite text-[length:var(--button-l-font-size)] tracking-[var(--button-l-letter-spacing)] leading-[var(--button-l-line-height)] whitespace-nowrap [font-style:var(--button-l-font-style)] font-bold">
            <CalendlyButton
              url="https://calendly.com/dom-gitfitcode/30min"
              text="Book Now"
            />
          </div>
        </div>
