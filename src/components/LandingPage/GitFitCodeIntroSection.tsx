...
export default function GitFitCodeIntroSection() {
  return (
    <section
      ...
      className="w-full my-5 flex flex-col items-center justify-center relative px-4 sm:px-8 md:px-8 lg:px-10 pt-24"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start lg:w-[75%] md:w-[80%]">
        ...
        <div className="flex flex-col items-start justify-center gap-4 ">
          ...
          <div className="all-[unset] box-border inline-flex h-14 items-center justify-center bg-[#00c2c6] text-white rounded-lg hover:bg-gfc-primary-100 hover:text-black transition duration-300 sm:w-[90%] lg:w-[60%]  w-full">
            <div className="all-[unset] box-border inline-flex h-14 items-center justify-center p-4 w-full">
              <CalendlyButton
