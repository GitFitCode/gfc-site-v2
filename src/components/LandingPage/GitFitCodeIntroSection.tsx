      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start lg:w-[75%] md:w-[80%]">
        ...
        <div className="flex flex-col items-start justify-center gap-4 ">
          ...
          <a
            ...
            className="all-[unset] box-border inline-flex h-14 items-center justify-center bg-[#00c2c6] text-white rounded-lg hover:bg-gfc-primary-100 hover:text-black sm:w-[90%] lg:w-[60%] transition duration-300"
          >
