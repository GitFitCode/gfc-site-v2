    ...
    <>
      ...
      >
        <RoundedMagneticButton
          ...
          className="relative z-[1000] top-[-40px] mr-[20px] w-[60px] h-[60px] bg-neutral-700 flex items-center justify-center rounded-full cursor-pointer shadow-lg border border-neutral-400"
        >
          <div
      ...
      <AnimatePresence mode="wait">
        {isSlideActive && <SlideNav setIsSlideActive={setIsSlideActive} />}
      </AnimatePresence>
    </>
  );
}
