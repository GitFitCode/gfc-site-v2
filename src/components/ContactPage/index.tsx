    ...
    >
      ...
      <div className="w-full lg:w-2/3 flex flex-col items-center justify-center gap-8">
        <div className="text-center">
          <h2 className="text-2xl lg:text-3xl font-bold py-8">
            Let’s Start Building Together
          </h2>
          {!isSubmitted && (
            <p className="text-sm lg:text-base mt-2">
              Have a project in mind or need advice on your next big idea?
              Please fill out the basics in the form below to get in touch with
        ...
        {isSubmitted ? (
          <div className="text-center">
            <p className="text-gfc-accent text-lg font-semibold mb-4">
              Thank you for your message! We'll get back to you soon.
            </p>
            <p className="text-gray-700">
              Redirecting you to the home page in <strong>{countdown}</strong>{" "}
              seconds.
            </p>
          </div>
        ) : (
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                ...
                <small className="text-gray-500 text-xs">
                  Include your phone # so we can reach you ASAP!
                </small>
              </div>
              <div className="flex-1">
